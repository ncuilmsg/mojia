...
return array (
  ...
  array (
    ...
    'logo' => 
    array (
      'src' => 'https://cdn.jsdelivr.net/gh/ncuilmsg/mojia@master/asset/img/logo.png',
      'link' => '/',
      'type' => 'logo',
      'desktop' => 'on',
      'mobile' => '0',
  ...
  array (
    ...
    array (
      'name' => '扫码观看',
      'pics' => 'https://cdn.jsdelivr.net/gh/ncuilmsg/mojia@master/asset/img/favicon.png',
      'send' => '关键词1',
      'code' => '长城',
      'type' => '',
    ),
    ...
    array (
      'name' => '视频标志',
      'pics' => 'https://cdn.jsdelivr.net/gh/ncuilmsg/mojia@master/asset/img/logo.png',
      'state' => '0',
      'width' => '25%',
      'height' => '60px',
      'margin' => '20px',
    ...
    array (
      'name' => '视频封面',
      'pics' => 'https://cdn.jsdelivr.net/gh/ncuilmsg/mojia@master/asset/img/loading.gif',
      'state' => '1',
    ),
    'advs' => 
    array (
  ...
  array (
    ...
    array (
      'name' => '静态加速',
      'link' => 'https://cdn.jsdelivr.net/gh/ncuilmsg/mojia',
      'local' => '0',
	  'debug' => '1',
      'state' => '1',
    ),
    ...
    array (
      ...
      'apis' => '',
      'regex' => '/(.*)/i',
      'image' => 'https://cdn.jsdelivr.net/gh/ncuilmsg/mojia@master/asset/img/image.jpg',
    ),
    'icon' => 
    array (
      'name' => '网站标志',
